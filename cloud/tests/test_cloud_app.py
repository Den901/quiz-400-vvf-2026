...
def test_complete_cloud_account_and_statistics_flow():
    with TestClient(app) as public_client:
        ...
        assert runtime.json()["version"] == "3.19.0"
        assert runtime.json()["releaseNotes"]["version"] == "3.19.0"
        assert runtime.json()["releaseNotes"]["showToUsers"] is False
        assert runtime.json()["releaseNotes"]["actionHash"] == "#study-paths"
        ...
        assert update_status.json()["currentVersion"] == "3.19.0"
